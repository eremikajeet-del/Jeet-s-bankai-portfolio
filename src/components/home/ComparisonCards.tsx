      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        {[1, 2, 3].map((i) => (
          <FadeIn key={i} delay={i * 0.2} y={30}>
            ...
            `}>
              <h3 className="text-text-tertiary font-bold text-xl uppercase tracking-wide">Option {i}</h3>
              <div className="text-text-tertiary font-light">
                <span className="text-4xl font-bold">$XX</span> / month
              </div>
              <ul className="flex flex-col gap-4 mt-4 flex-1">
                <li className="text-text-tertiary/70 font-light text-sm flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-text-tertiary"></div> Feature 1
                </li>
                <li className="text-text-tertiary/70 font-light text-sm flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-text-tertiary"></div> Feature 2
                </li>
                <li className="text-text-tertiary/70 font-light text-sm flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-text-tertiary"></div> Feature 3
                </li>
              </ul>
              <button className={`
                ...
                ${i === 2 
                  ...
                  : 'bg-transparent border border-border-default text-text-tertiary hover:bg-text-tertiary/10'}
              `}>
                Select Plan
              </button>
            </div>
