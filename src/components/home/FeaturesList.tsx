    ...
    <section className="py-12 px-6 md:px-10 max-w-6xl mx-auto">
      <FadeIn delay={0.2} y={30}>
        <div className="bg-surface-strong border border-border-muted/10 rounded-[40px] md:rounded-[60px] p-8 md:p-16">
          <h2 className="text-text-primary font-bold text-2xl md:text-4xl mb-8 uppercase tracking-wide">
            Why work with me
          </h2>
          <ul className="flex flex-col gap-6">
            {features.map((feature, i) => (
              <FadeIn key={i} delay={0.3 + (i * 0.1)} y={20}>
                <li className="flex items-center gap-4 text-text-primary/80 text-lg md:text-xl font-light">
                  <div className="w-8 h-8 rounded-full bg-text-primary/10 flex items-center justify-center shrink-0">
